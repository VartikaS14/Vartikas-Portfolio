    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          ...
          Passionate about crafting seamless web experiences <span className='text-[#E65100]'>and</span> <br></br>solving complex problems with data structures and algorithms.
          </p>
        </div>
      </div>
      <ComputersCanvas/>
